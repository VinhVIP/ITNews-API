...
export declare type PoolClientWithConnection = PoolClient & {
...
declare type PoolEmitter = StrictEventEmitter<EventEmitter, PoolEvents>;
...
export declare class Pool extends Pool_base {
     ...
     */
    query<TRow extends QueryResultRow = any>(text: string, values: {
        [index: string]: any;
